...
- [x]お気に入り登録の自動リロール無し
- [ ]体育系の枠の下にバスケ部が謎にある
- [x]*部長、副部長がメンバー管理できるような権限が欲しい。*
- [ ]メッセージ機能追加
- [x]部長副部長の認識
- [ ]活動報告書の作成、メールへテンプレありのデータを添付したやつを表示させるように
- [ ]活動報告書は部長副部長にさせるので管理者画面を作成
- [ ]借用者は名前だけ表示
- [x] メッセージ機能追加（公開・非公開/部内限定の選択機能）
- [x] 活動報告書のExcel（CSV）エクスポート・鍵履歴との自動マッピング機能
- [x] 大学発行のGoogleアカウント（@do-johodai.ac.jp）ログイン連携（OAuth2.0 / 開発用モック）
- [ ] LINE / Discord への鍵貸し借り状態の自動通知連携 (Webhooks)
- [ ] 活動報告への写真・画像添付機能
